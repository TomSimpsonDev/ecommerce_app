...
passport.use(new GoogleStrategy({
  ...
  callbackURL: `${process.env.REACT_APP_API_ENDPOINT}/auth/google/callback` || "http://localhost:8000/auth/google/callback"
},
...
passport.use(new TwitterStrategy({
  ...
  callbackURL: `${process.env.REACT_APP_API_ENDPOINT}/auth/twitter/callback` || "http://localhost:8000/auth/twitter/callback",
...
router.get('/google/callback',
  ...
  (req, res) => {
    res.redirect(process.env.REACT_APP_API_ENDPOINT || 'http://localhost:3000');
  }
);
