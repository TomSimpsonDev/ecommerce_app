...
passport.use(new GoogleStrategy({
  ...
  callbackURL: process.env.REACT_APP_API_ENDPOINT + "/auth/google/callback",
},
...
passport.use(new TwitterStrategy({
  ...
  callbackURL: process.env.REACT_APP_API_ENDPOINT + "/auth/twitter/callback",
...
router.get('/google/callback',
  ...
  (req, res) => {
    res.redirect(process.env.REACT_APP_API_ENDPOINT);
  }
);
